...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.combobox_ping = ctk.CTkComboBox(self.tabview.tab("Подключение"), values=["None", "/t", "/a"], width=80, justify="c", state="readonly", font=ctk.CTkFont(family="Trebuchet MS", size=13, weight="bold"))
        ...
        self.combobox_tracert = ctk.CTkComboBox(self.tabview.tab("Подключение"), values=[" None ", "/d", "/j"], width=80, justify="c", state="readonly", font=ctk.CTkFont(family="Trebuchet MS", size=13, weight="bold"))
