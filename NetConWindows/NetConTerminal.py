...
class NetConTerminal(ctk.CTkToplevel):
    def __call__(self, theme, ip_address, con_type, scale, opacity, master, language):
        ...
        self.tab_flag = False # новое
        self.help_mode = False
        self.empty_help = False
        self.is_esr = False
        self.check_esr_flag = True
        self.esr_show_mode = False
        self.last_word = ""
        self.input_before_help = ""
        self.old_name = ""
        self.new_height = 0
        self.many_input = ""
        self.current_input = ""
    ...
    def create_widgets(self):
        ...
        self.cleartext_img = ctk.CTkImage(dark_image=Image.open(path_img + "img/clear_terminal.png"), size=(18, 18))
        ...
        self.help_img = ctk.CTkImage(dark_image=Image.open(path_img + "img/help_terminal.png"), size=(18, 18))
        ...
        if self.theme == "Темная" or self.theme == "Dark":
            self.clear_username = ctk.CTkButtonSoftHover(self.settings_frame, width=20, border_width=0, normal_color="#212121", fg_color="#212121", hover=False, image=self.clear_img, text="", command=lambda: [self.after(150, lambda: self.anim_hover.animate_hover(self.clear_username, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")), self.username.delete(0, "end"), self.after(100, lambda: self.username.focus_set())])
            self.clear_username.grid(row=0, column=2, padx=(5, 0), pady=(25, 5), sticky="e")
            self.clear_username.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.clear_username, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")])
            self.clear_username._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.clear_username, "212121", "333333", "10101", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_username, "212121", "333333", "10101", upper=True))
            self.anim_hover.init_hover_state(self.clear_username)
        else:
            self.clear_username = ctk.CTkButtonSoftHover(self.settings_frame, width=20, border_width=0, normal_color="#e5e5e5", fg_color="#e5e5e5", hover=False, image=self.clear_img, text="", command=lambda: [self.after(150, lambda: self.anim_hover.animate_hover(self.clear_username, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up")), self.username.delete(0, "end"), self.after(100, lambda: self.username.focus_set())])
            self.clear_username.grid(row=0, column=2, padx=(5, 0), pady=(25, 5), sticky="e")
            self.clear_username.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.clear_username, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up")])
            self.clear_username._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.clear_username, "e5e5e5", "ffffff", "20202", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_username, "e5e5e5", "ffffff", "20202", upper=True))
            self.anim_hover.init_hover_state(self.clear_username)
        ...
        self.password._entry.grid_configure(padx=(6, 35))

        if self.theme == "Темная" or self.theme == "Dark":
            self.clear_password = ctk.CTkButtonSoftHover(self.settings_frame, width=20, border_width=0, normal_color="#212121", fg_color="#212121", hover=False, image=self.clear_img, text="", command=lambda: [self.after(150, lambda: self.anim_hover.animate_hover(self.clear_password, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")), self.password.delete(0, "end"), self.after(100, lambda: self.password.focus_set())])
            self.clear_password.grid(row=0, column=5, padx=(5, 10), pady=(25, 5), sticky="e")
            self.clear_password.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.clear_password, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")])
            self.clear_password._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.clear_password, "212121", "333333", "10101", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_password, "212121", "333333", "10101", upper=True))
            self.anim_hover.init_hover_state(self.clear_password)
        else:
            self.clear_password = ctk.CTkButtonSoftHover(self.settings_frame, width=20, border_width=0, normal_color="#e5e5e5", fg_color="#e5e5e5", hover=False, image=self.clear_img, text="", command=lambda: [self.after(150, lambda: self.anim_hover.animate_hover(self.clear_password, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up")), self.password.delete(0, "end"), self.after(100, lambda: self.password.focus_set())])
            self.clear_password.grid(row=0, column=5, padx=(5, 10), pady=(25, 5), sticky="e")
            self.clear_password.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.clear_password, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up")])
            self.clear_password._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.clear_password, "e5e5e5", "ffffff", "20202", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_password, "e5e5e5", "ffffff", "20202", upper=True))
            self.anim_hover.init_hover_state(self.clear_password)
        ...
        self.connect_button = ctk.CTkButtonSoftHover(self.settings_frame, width=50, text="", normal_color="#1F538D", fg_color="#1F538D", hover=False, is_disabled=True, command=self.connect, image=self.connect_img, font=ctk.CTkFont(family="Trebuchet MS", size=14, weight="bold"))
        self.connect_button.grid(row=0, column=7, padx=(0,0), pady=(25,5), sticky = "nse")
        self.connect_button.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.connect_button, int("1f538d", 16), int("0f334d", 16), int("10204", 16), 10, "down")])  # print("IN")
        self.connect_button._image_label.bind("<Enter>", lambda var_in: self.anim_hover.stop_leave(self.connect_button))
        self.connect_button._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.connect_button, "1f538d", "0f334d", "10204"))
        self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.connect_button, "1f538d", "0f334d", "10204"))
        self.anim_hover.init_hover_state(self.connect_button)

        self.disconnect_button = ctk.CTkButtonSoftHover(self.settings_frame, width=50, state="disabled",  normal_color="#f4740b", fg_color="#94440B", is_disabled=True, hover=False, command=self.disconnect, border_width=0, image=self.disconnect_disabled_img, text="")
        self.disconnect_button.grid(row=0, column=8, padx=(10,0), pady=(25,5), sticky = "nsew")
        self.disconnect_button.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.disconnect_button, int("f4740b", 16), int("94440B", 16), int("60300", 16), 10, "down")])
        self.disconnect_button._image_label.bind("<Enter>", lambda var_in: self.anim_hover.stop_leave(self.disconnect_button))
        self.disconnect_button._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.disconnect_button, "f4740b", "94440B", "60300"))
        self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.disconnect_button, "f4740b", "94440B", "60300"))
        self.anim_hover.init_hover_state(self.disconnect_button)

        if self.theme == "Темная" or self.theme == "Dark":

            self.help_btn = ctk.CTkButtonSoftHover(master=self.settings_frame, width=20, normal_color="#212121", fg_color="#212121", text_color="gray32", hover=False, border_width=0, height=18, image=self.help_img, text="", font=ctk.CTkFont(size=11, weight="bold"), command=self._show_help)
            self.help_btn.grid(row=0, column=9, padx=(10, 0), pady=(25, 5), sticky="nsew")
            self.help_btn.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.help_btn, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")])
            self.help_btn._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.help_btn, "212121", "333333", "10101", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.help_btn, "212121", "333333", "10101", upper=True))
            self.anim_hover.init_hover_state(self.help_btn)

            self.search_btn = ctk.CTkButtonSoftHover(self.settings_frame, width=20, normal_color="#212121", fg_color="#212121", hover=False, image=self.search_img, height=18, border_width=0, text="", command=self.open_search_window)
            self.search_btn.grid(row=0, column=10, padx=(10, 0), pady=(25, 5), sticky="nsew")
            self.search_btn.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.search_btn, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")])
            self.search_btn._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.search_btn, "212121", "333333", "10101", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.search_btn, "212121", "333333", "10101", upper=True))
            self.anim_hover.init_hover_state(self.search_btn)

            self.clearbut = ctk.CTkButtonSoftHover(self.settings_frame, width=20,  normal_color="#212121", fg_color="#212121", hover=False, image=self.cleartext_img, height=18, border_width=0, text="", command=self.clear_text)
            self.clearbut.grid(row=0, column=11, padx=(10,25), pady=(25,5), sticky = "nsew")
            self.clearbut.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.clearbut, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")])
            self.clearbut._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.clearbut, "212121", "333333", "10101", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clearbut, "212121", "333333", "10101", upper=True))
            self.anim_hover.init_hover_state(self.clearbut)

            self.settings_toggle_button = ctk.CTkButtonSoftHover(self, text="▲", width=20, height=20, command=self.toggle_settings_frame, corner_radius=0, normal_color="#212121", fg_color="#212121", hover=False, is_disabled=True, text_color=("#212121", "#DCE4EE"), font=("Consolas", 13, "bold"))
            self.settings_toggle_button.grid(row=1, column=0, columnspan=2, sticky="nsew")
            self.settings_toggle_button.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.settings_toggle_button, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up")])
            self.settings_toggle_button._text_label.bind("<Enter>", lambda var_in: [self.anim_hover.stop_leave(self.settings_toggle_button)])
            self.settings_toggle_button._text_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.settings_toggle_button, "212121", "333333", "10101", upper=True))
            self.settings_toggle_button.bind("<Leave>", lambda out_of_btn: [self.anim_hover.check_color(self.settings_toggle_button, "212121", "333333", "10101", upper=True, modal=True)])  # print("IN")
            self.anim_hover.init_hover_state(self.settings_toggle_button)

        else:

            self.help_btn = ctk.CTkButtonSoftHover(master=self.settings_frame, width=20, normal_color="#e5e5e5", fg_color="#e5e5e5", text_color="gray32", hover=False, border_width=0, image=self.help_img, height=18, text="", font=ctk.CTkFont(size=11, weight="bold"), command=self._show_help)
            self.help_btn.grid(row=0, column=9, padx=(10, 0), pady=(25, 5), sticky="nsew")
            self.help_btn.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.help_btn, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up")])
            self.help_btn._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.help_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.help_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.anim_hover.init_hover_state(self.help_btn)

            self.search_btn = ctk.CTkButtonSoftHover(self.settings_frame, width=20, normal_color="#e5e5e5", fg_color="#e5e5e5", hover=False, image=self.search_img, height=18, border_width=0, text="", command=self.open_search_window)
            self.search_btn.grid(row=0, column=10, padx=(10, 0), pady=(25, 5), sticky="nsew")
            self.search_btn.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.search_btn, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up")])
            self.search_btn._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.search_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.search_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.anim_hover.init_hover_state(self.search_btn)

            self.clearbut = ctk.CTkButtonSoftHover(self.settings_frame, width=20, normal_color="#e5e5e5", fg_color="#e5e5e5", hover=False, image=self.cleartext_img, height=18, border_width=0, text="", command=self.clear_text)
            self.clearbut.grid(row=0, column=11, padx=(10, 25), pady=(25, 5), sticky="nsew")
            self.clearbut.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.clearbut, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up")])
            self.clearbut._image_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.clearbut, "e5e5e5", "ffffff", "20202", upper=True))
            self.settings_frame.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clearbut, "e5e5e5", "ffffff", "20202", upper=True))
            self.anim_hover.init_hover_state(self.clearbut)

            self.settings_toggle_button = ctk.CTkButtonSoftHover(self, text="▲", width=20, height=20, command=self.toggle_settings_frame, corner_radius=0, normal_color="#e5e5e5", fg_color="#e5e5e5", hover=False, is_disabled=True, text_color=("#212121", "#DCE4EE"), font=("Consolas", 13, "bold"))
            self.settings_toggle_button.grid(row=1, column=0, columnspan=2, sticky="nsew")
            self.settings_toggle_button.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.settings_toggle_button, int("e5e5e5", 16), int("d5d5d5", 16), int("10101", 16), 10, "down")])
            self.settings_toggle_button._text_label.bind("<Enter>", lambda var_in: [self.anim_hover.stop_leave(self.settings_toggle_button)])
            self.settings_toggle_button._text_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.settings_toggle_button, "e5e5e5", "d5d5d5", "10101"))
            self.settings_toggle_button.bind("<Leave>", lambda out_of_btn: [self.anim_hover.check_color(self.settings_toggle_button, "e5e5e5", "d5d5d5", "10101", modal=True)])  # print("IN")
            self.anim_hover.init_hover_state(self.settings_toggle_button)
        ...
        self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.connect_button, "1f538d", "0f334d", "10204"))
        self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.disconnect_button, "f4740b", "94440B", "60300"))
        self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.connect_button, "1f538d", "0f334d", "10204"))
        self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.disconnect_button, "f4740b", "94440B", "60300"))
        if self.theme == "Темная" or self.theme == "Dark":
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_username, "212121", "333333", "10101", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_password, "212121", "333333", "10101", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.help_btn, "212121", "333333", "10101", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.search_btn, "212121", "333333", "10101", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clearbut, "212121", "333333", "10101", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_username, "212121", "333333", "10101", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_password, "212121", "333333", "10101", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.help_btn, "212121", "333333", "10101", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.search_btn, "212121", "333333", "10101", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clearbut, "212121", "333333", "10101", upper=True))
        else:
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_username, "e5e5e5", "ffffff", "20202", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_password, "e5e5e5", "ffffff", "20202", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.help_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.search_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clearbut, "e5e5e5", "ffffff", "20202", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_username, "e5e5e5", "ffffff", "20202", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clear_password, "e5e5e5", "ffffff", "20202", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.help_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.search_btn, "e5e5e5", "ffffff", "20202", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.clearbut, "e5e5e5", "ffffff", "20202", upper=True))

        """
        if self.theme == "Темная" or self.theme == "Dark":
            self.input_label.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.settings_toggle_button, "212121", "333333", "10101", upper=True))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.settings_toggle_button, "212121", "333333", "10101", upper=True))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.settings_toggle_button, "212121", "333333", "10101", upper=True))
        else:
            self.input_label.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.settings_toggle_button, "e5e5e5", "d5d5d5", "10101"))
            self.input_entry.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.settings_toggle_button, "e5e5e5", "d5d5d5", "10101"))
            self.text_area.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.settings_toggle_button, "e5e5e5", "d5d5d5", "10101"))
        """
        if self.language == "Русский":
        ...
        self.after(100, lambda: self.bind("<Next>", lambda next: self.text_area.yview_scroll(20, "units")))
        self.after(100, lambda: self.bind("<Prior>", lambda next: self.text_area.yview_scroll(-20, "units")))
    ...
    def _on_closing(self):
        if self.language == "Русский":
            msg = CTkMessagebox(opacity=self.opacity, message='Завершить сессию?', title='Внимание!', icon='warning', option_1="Отмена", option_2="Да", master=self, button_width=200)
        else:
            msg = CTkMessagebox(opacity=self.opacity, message='End session?', title='Attention!', icon='warning', option_1="Cancel", option_2="Yes", master=self, button_width=200)
        #msg.button_1.configure(fg_color="#f4740b", hover_color="#94440B")
        msg.focus_set()
        response = msg.get()
    ...
    def toggle_settings_frame(self):
        ...
        if self.settings_frame_hidden:
            ...
            self.settings_frame.grid(row=0, column=0, sticky="nsew", columnspan=2)
            self.animate_padding(self.settings_frame, 0, 58, 1, 3, "grow")
            ...
            self.unbind("<F8>")
            self.hide_widgets()
            self.animate_padding(self.settings_frame, 58, 0, 1, 3, "die")
            self.settings_toggle_button.configure(text="▼")
            ...
            if self.connect_button.cget("state") == "normal":
                self.connect_button.configure(fg_color="#1F538D")
            if self.disconnect_button.cget("state") == "normal":
                self.disconnect_button.configure(fg_color="#f4740b")
            """
            if self.theme == "Темная" or self.theme == "Dark":
                self.clear_username.configure(fg_color="#212121")
                self.clear_password.configure(fg_color="#212121")
                self.help_btn.configure(fg_color="#212121")
                self.search_btn.configure(fg_color="#212121")
                self.clearbut.configure(fg_color="#212121")
                #self.anim_hover.check_color(self.settings_toggle_button, "212121", "333333", "10101", upper=True)
            else:
                self.clear_username.configure(fg_color="#e5e5e5")
                self.clear_password.configure(fg_color="#e5e5e5")
                self.help_btn.configure(fg_color="#e5e5e5")
                self.search_btn.configure(fg_color="#e5e5e5")
                self.clearbut.configure(fg_color="#e5e5e5")
                #self.anim_hover.check_color(self.settings_toggle_button, "e5e5e5", "d5d5d5", "10101")
            """
            self.update_idletasks()
    ...
    def _connect_thread(self, device):
        try:
            ...
            self.connect_button.configure(state="disabled", image=self.connect_disabled_img, fg_color="#0f334d")
            self.disconnect_button.configure(state="normal", fg_color="#f4740b", image=self.disconnect_img)
            ...
            self.input_entry.bind('<?>', lambda x: self.send_help(f"{self.input_entry.get()}\x3F"))  # при выводе справки при нажатии на "?" (непонятно пока что отправлять после вопроса, пробел или \r) # новое: нашел решение?
            self.net_connect = netmiko.ConnectHandler(**device)
            self.running = True
            if self.language != "Русский":
                self.append_output(f"\n Connected to: {device["host"]} via {self.con_type}.")
            else:
                self.append_output(f"\n Подключено к: {device["host"]} через {self.con_type}.")
            threading.Thread(target=self.process_output_queue, daemon=True).start()
            self.after(200, lambda: [self.input_entry.focus_set(), self.stop_text_area_read_input(), self.check_message(), self.send_command(aft_con=True)])
            self.after(500, lambda: self.back_text_area_read_input())
            self.text_area.see("end")
            ...
            #self.settings_toggle_button.configure(text="▼")
            #self.settings_frame_hidden = True
            if not self.settings_frame_hidden:  # test
    ...
    def bad_connect(self):
        ...
        self.disconnect_button.configure(state="disabled", fg_color="#94440B", image=self.disconnect_disabled_img)
    ...
    def disconnect(self):
        if self.net_connect:
            ...
            self.net_connect = None
            self.running = False
            self.check_esr_flag = False
            self.stop_event.set()  # Stop reading thread
            if self.language != "Русский":
                self.append_output(f"\n Disconnected from: {self.device_ip}.")
            else:
                self.append_output(f"\n Отключено от: {self.device_ip}.")
            self.adjust_textbox_height()
            self.text_area.configure(state="disabled")
            self.username.configure(state="normal", border_color=("#979da2", "#565b5e"), text_color=("gray14", "gray84"))
            self.password.configure(state="normal", border_color=("#979da2", "#565b5e"), text_color=("gray14", "gray84"))
            ...
            #self.settings_toggle_button.configure(text="▲")
            #self.settings_frame_hidden = False
            if self.settings_frame_hidden: #test
                self.toggle_settings_frame()
            self.bar_height = 108
            self.adjust_textbox_height()
            self.text_area.configure(height=self.new_height)
    ...
    def process_output_queue(self):
        ...
        def key_q(event):
            if event.keycode == 81:  # Клавиша с буквой Й и с англ. буквой Q
                ...
                self.after(500, lambda: [self.back_text_area_read_input(), self.unbind('<space>'), self.send_command2("" + "\r"), self.unbind('<KeyPress>'), self.unbind('<Control-KeyPress>')])
        ...
        try:
            while self.running and self.net_connect:
                ...
                #print(line.encode())
                if self.check_esr_flag:
                    if ((b'[81D' in line.encode() and b'[80D' in line.encode() and b'12C' in line.encode()) and self.con_type == "Telnet") or ((b'[512D' and line.encode() and b'[12C' in line.encode() and b'[511D' in line.encode()) and self.con_type != "Telnet"):  # [74D # новое: детект есров
                        self.is_esr = True
                    else:
                        self.is_esr = False
                    self.check_esr_flag = False
                ...
                if self.current_input != "" and self.line.replace(" ", "").replace("\n", "").replace(self.current_name, "") == "" or ("?" in self.line and not self.is_esr):
                    index = line.find("#")
                    self.find_device_name(line[:index + 1])
                    continue
                if "more" in line.lower():  # Other
                    if self.language != "Русский":
                        if self.help_mode:  # новое: замена для вывода справки
                            self.input_label.configure(text="  Back: <Enter>", font=("Consolas", 14))
                            self.old_name = "  Back: <Enter>"
                        else:
                        ...
                        if self.help_mode:
                            self.input_label.configure(text="  Вернуться: <Enter>", font=("Consolas", 14))
                            self.old_name = "  Вернуться: <Enter>"
                        else:
                    ...
                    if self.flag == 1:
                        ...
                        self.adjust_textbox_height()
                        self.text_area.configure(state="disabled")
                    if self.help_mode: #and not self.is_esr:  # новое: автоотправка продолжения при выводе справки (необходимый костыль для обхода приколов, теперь справка выводится непрерывно)
                        self.net_connect.write_channel(" ".encode())
                    ...
                    if self.help_mode:
                        if self.current_input.lstrip().lower().startswith("sh") and self.is_esr:
                            self.input_entry.configure(state="readonly")
                        else:
                            self.input_entry.configure(state="readonly")
                            if self.language != "Русский":
                    ...
                    if self.flag == 1:
                        ...
                        #if self.is_esr and self.help_mode:
                        ...
                        if line.replace("\n", "").rstrip().lstrip() not in self.old_line.replace("\n", "").rstrip().lstrip() and self.current_input in line and self.current_input != "" and "login:" not in self.line.lower() and "%" not in line and "^" not in line and "syntax error" not in self.line.lower() or ("\n" in self.current_input and esr_input_trigger):
                            ...
                            if line.replace(" ","") != "\n":
                                if self.help_mode and self.current_name in self.line:
                                    #if self.is_esr:
                                    self.text_area.insert("end", f"\n {self.current_name + self.input_before_help.replace("?","").replace("\x03 ","").replace("\r","")}")
                                else:
                                    self.text_area.insert("end", f"\n {line.replace("\n", "")}")  # думать + думать жоска
                                    self.old_line = "8425902375"
                        x = self.text_area.get("1.0", "end").count("\n")
                        if ("%" in self.text_area.get(f"{x - 1}.0", "end").lower() or "configuring" in self.text_area.get(f"{x - 1}.0", "end").lower() or "syntax error" in self.text_area.get(f"{x - 1}.0", "end").lower()) and self.old_name.strip() in self.text_area.get(f"{x}.0", "end") and self.next_after_conf: #or self.is_esr:
                            self.text_area.configure(state="normal")
                ...
                if self.empty_help:  # новое: делал для есров но вроде работает везде тоже норм, это для вывода пустой справки, общей
                    ...
                    self.empty_help = False
                if self.current_input.lstrip().lower().startswith("sh") and self.con_type == "Telnet" and self.is_esr and not self.help_mode and not re.fullmatch(r"^[show? ]+$", self.current_input):
                    pyautogui.press("enter")
                self.text_area.see("end")
                x = self.text_area.get("1.0", "end").count("\n")
                last_string = self.text_area.get(f"{x}.0", "end")
                if "Choose the size of the key modulus" in last_string:
                    self.input_label.configure(text="  How many bits in the modulus:", font=("Consolas", 14))
                    self.old_name = "  How many bits in the modulus:"
                    continue
                if "You already have RSA keys defined named" in last_string:
                    self.send_command()
                if ">" in self.current_name:
                    if 'Password:' in last_string:
                        self.send_command()
                    if ">en" in last_string.lower():
                        self.stop_text_area_read_input()
                        ...
                        continue
                if "#" in line and len(line) < 60 and "# " not in line.rstrip() and " #" not in line:
                    index = line.find("#")
                    self.find_device_name(line[:index + 1])
                elif ">" in line and len(line) < 60 and "> " not in line.rstrip() and " >" not in line and "cr" not in line.lower():
                    index = line.find(">")
                    self.find_device_name(line[:index + 1])
                elif "]" in line and "[" in line and len(line) < 60 and "] " not in line.rstrip() and " ]" not in line and "cr" not in line.lower():
                    index = line.find("]")
                    self.find_device_name(line[:index + 1])
        except Exception as e:
            self.disconnect()
    ...
    def find_last_string(self, sentence, added_word):
        words = sentence.split()
        last_word = words[-1].lstrip().rstrip()
        self.last_word = last_word
        if last_word in added_word:
            return True
        else:
            return False
    ...
    def del_fuck_after_tab(self):  # пока спорно, на циске работает
        ...
        if len(final.rstrip()) > len(self.old_input.rstrip()):
            ...
            try:
                if self.find_last_string(self.input_entry.get(), added_word.rstrip().replace("z1x1c", "")):
                    index = self.input_entry.get().find(" " + self.last_word)
                    self.input_entry.delete(index, "end")
                    self.input_entry.insert("end", " ")
                    self.last_word = ""
                    added_word = added_word.split()
                    added_word = added_word[-1] + " "
            except:
                return print("Была ошибка")
    ...
    def reload_alert(self):
        ...
        if "%" in y:
            self.net_connect.write_channel("\r".encode())
        else:
            self.text_area.configure(state="normal")
            if self.language != "Русский":
    ...
    def hide_write(self, not_write=False):
        self.stop_text_area_read_input()
        if not not_write:
            self.net_connect.write_channel(self.nullstring.encode())
    ...
    def check_cisco(self):
        x = self.text_area.get("1.0", "end").count("\n")
        last_string = self.text_area.get(f"{x}.0", "end")
        if "Incomplete" in last_string:
            self.clear_text(non_click=True)
            self.after(100)
            self.net_connect.write_channel("crypto key generate rsa \r".encode())
            self.update_command_list("crypto key generate rsa\r")
        else:
            self.clear_text(non_click=True)
            self.after(100)
            self.net_connect.write_channel("crypto key generate rsa".encode())
    ...
    def check_message(self):
        self.stop_text_area_read_input()
        self.check_esr_flag = True
        self.net_connect.write_channel("show sada2312412\r".encode())

    def send_command(self, aft_con=False):  # для элтексов вроде заебца
        if self.net_connect:
            self.tab_flag = False
            if self.help_mode and not self.esr_show_mode:
                self.stop_text_area_read_input()
                self.net_connect.write_channel("show sada2312412\r".encode())
                self.help_mode = False
                self.input_entry.configure(state="normal")
                self.after(100, lambda: self.input_entry.insert("end", self.input_before_help.lstrip().replace("?","").replace("\x03 ","").replace("\r","")))
                self.after(300, lambda: [self.back_text_area_read_input()])
            self.esr_show_mode = False
            self.many_input = ""
            ...
            elif (("cr" in command.lower() and command.lower().startswith("cr") and "key" in command.lower() and "ge" in command.lower()) or
                  ("no" in command.lower() and command.lower().startswith("no") and "key" in command.lower() and "cr" in command.lower())) and "ze" not in command.lower():
                self.net_connect.write_channel("vtp \r \r".encode())
                self.after(200, lambda: self.check_cisco())
            else:
                if command.lower().lstrip().startswith("conf") and " t" not in command.lower() and "r" not in command.lower():
                    com_conf = "configure " + "\r"
                    self.net_connect.write_channel(com_conf.encode())
                    self.input_entry.delete(0, "end")
                    self.update_command_list(command)
                    return self.after(100, lambda: self.send_command())
                else:
                    self.net_connect.write_channel(command.encode())
                if self.old_name == "  How many bits in the modulus:":
                    self.input_label.configure(text=f"  {self.current_name}", font=("Consolas", 14))
                if command.strip() != "" and "login:" not in self.line.lower() and ("#" in self.line or ">" in self.line or ("[" in self.line and "]" in self.line)):  # последнее условие пока не точно
                    self.update_command_list(command)
                    self.net_connect.write_channel(self.nullstring.encode())
            self.input_entry.delete(0, "end")
        self.counter = len(self.last_command_list)
    ...
    def not_esr_input(self):
        if not self.is_esr:
            self.text_area.configure(state="normal")
            self.text_area.insert("end", f"\n {self.current_name + self.input_before_help.replace("?","").replace("\x03 ","").replace("\r","")}")
            self.text_area.configure(state="disabled")

    def send_help(self, command): # новое
            self.tab_flag = False
            self.esr_show_mode = False
            if command.lstrip().lower().startswith("sh") and len(command.split(" ")) == 2 and re.fullmatch(r"^[show? ]+$", command) or command.lstrip().lower().startswith("dis") and len(command.split(" ")) == 2 and re.fullmatch(r"^[display? ]+$", command):
                if not self.is_esr:
                    command = command + "\r"
            if command == "?":
                self.empty_help = True
                self.input_before_help = ""
            else:
                self.empty_help = False
                self.input_before_help = command
            self.help_mode = True
            self.current_input = "" #self.current_input = command.replace("? ","") было нужно для сохранения инпута на есрах, но ломает вывод справки после таба на коммутаторах UPD: неужели сброс просто починил????
            self.net_connect.write_channel(command.encode())
            self.input_entry.configure(state="normal")
            self.input_entry.delete(0, "end")
            self.input_entry.configure(state="readonly")
    ...
    def find_device_name(self, var_line):
        if "#" in var_line and "more" not in self.line.lower() and 60 > len(var_line) > 1:
            s = var_line.replace("\n","")
            index = s.find("#")
            ...
            if index == len(s)-1:
                ...
                if self.old_name !=s:
                    ...
                    x = self.text_area.get("1.0", "end").count("\n")
                    if ">" in self.text_area.get(f"{x}.0", "end") or "#" in self.text_area.get(f"{x}.0", "end") or "]" in self.text_area.get(f"{x}.0", "end"):
                        self.text_area.configure(state="normal")
                        self.text_area.delete(f"{x}.0", "end")
                        self.text_area.configure(state="disabled")
                        self.adjust_textbox_height()
                        self.text_area.see("end")
                self.old_name = s
        elif ">" in var_line and "more" not in self.line.lower() and 60 > len(var_line) > 1:
            s = var_line.replace("\n","")
            index = s.find(">")
            if var_line.replace("\n", "").replace(self.old_name.lstrip(),"") == self.old_input and self.old_input != "":
                #print("catch")
    ...
    def clear_text(self, non_click=False):
        if not non_click:
            if self.theme == "Темная" or self.theme == "Dark":
                self.after(150, lambda: self.anim_hover.animate_hover(self.clearbut, int("212121", 16), int("333333", 16), int("10101", 16), 10, "up"))
            else:
                self.after(150, lambda: self.anim_hover.animate_hover(self.clearbut, int("e5e5e5", 16), int("ffffff", 16), int("20202", 16), 10, "up"))
        self.text_area.configure(state="normal")
