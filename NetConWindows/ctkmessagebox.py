...
class CTkMessagebox(ctk.CTkToplevel):
    ...
    def __init__(self,
        ...
        if self.cancel_button == "cross":
            ...
            self.button_close = ctk.CTkButton(self.frame_top, corner_radius=10, width=10, height=10,
                                                         hover=False, border_width=0,
                                                         text="",
        ...
        self.title_label = ctk.CTkLabel(self.frame_top, width=1, text=self._title,
        ...
        self.info = ctk.CTkButton(self.frame_top, width=1, height=self.height / 2, corner_radius=0,
        ...
        self.button_1 = ctk.CTkButtonSoftHover(self.frame_top, text=self.option_text_1, normal_color="#1F538D",
                                                 fg_color="#1F538D", hover=False, is_disabled=True,
        ...
        self.frame_top.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.button_1, "1f538d", "0f334d", "10204"))
        ...
        if option_2:
            ...
            self.button_1 = ctk.CTkButtonSoftHover(self.frame_top, text=self.option_text_1, normal_color="#f4740b",
                                                   fg_color="#f4740b", hover=False, is_disabled=True,
                                                   font=ctk.CTkFont(family=("Trebuchet MS"), size=14, weight="bold"),
                                                   width=self.button_width, height=self.button_height,
                                                   command=lambda: self.button_event(self.option_text_1))

            self.button_1.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.button_1, int("f4740b", 16), int("94440B", 16), int("60300", 16), 10, "down")])  # print("IN")
            self.button_1._text_label.bind("<Enter>", lambda var_in: self.anim_hover.stop_leave(self.button_1))
            self.button_1._text_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.button_1, "f4740b", "94440B", "60300"))
            self.frame_top.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.button_1, "f4740b", "94440B", "60300"))
            self.anim_hover.init_hover_state(self.button_1)

            self.button_2 = ctk.CTkButtonSoftHover(self.frame_top, text=self.option_text_2,
                                                     normal_color="#1F538D",
                                                     fg_color="#1F538D", hover=False, is_disabled=True,
                                                     font=ctk.CTkFont(family=("Trebuchet MS"), size=14, weight="bold"),
                                                     width=self.button_width, height=self.button_height,
            ...
            self.button_2.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self.button_2, int("1f538d", 16), int("0f334d", 16), int("10204", 16), 10, "down")])  # print("IN")
            self.button_2._text_label.bind("<Enter>", lambda var_in: self.anim_hover.stop_leave(self.button_2))
            self.button_2._text_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self.button_2, "1f538d", "0f334d", "10204"))
            self.frame_top.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self.button_2, "1f538d", "0f334d", "10204"))
            self.anim_hover.init_hover_state(self.button_2)

        self.option_text_3 = option_3
        if option_3:
            self.button_3 = ctk.CTkButton(self.frame_top, text=self.option_text_3,
        ...
        self.bind("<Return>", lambda e: self.button_event(self.option_text_2)) #НЕ ТОЧНО (Был 1)
