...
class Help(ctk.CTkToplevel):
    def __call__(self, var, master, opacity, language):
            ...
            if tab_name == "Терминал":
                ...
                if self.language == "Русский":
                    ...
                    self.textbox.insert("end", " \n ● «Горячие» клавиши:\n \n"
                                               ...
                                               " 13. «PageUp» - пролистать терминал вверх.\n"
                                               " 14. «PageDown» - пролистать терминал вниз.\n"
                                        )
                else:
                    self.textbox.insert("end", " \n ● «SerialTerminal»:\n  \n"
                    ...
                    self.textbox.insert("end", " \n ● Hotkeys:\n \n"
                                               ...
                                               " 13. «PageUp» - scroll up the terminal.\n"
                                               " 14. «PageDown» - scroll down the terminal.\n"
                                        )
            ...
            if tab_name == "Телнет":
                ...
                if self.language == "Русский":
                    ...
                    self.textbox.insert("end", " \n ● «Горячие» клавиши:\n \n"
                                               ...
                                               " 12. «PageUp» - пролистать терминал вверх.\n"
                                               " 13. «PageDown» - пролистать терминал вниз.\n"
                                        )
                else:
                    self.textbox.insert("end", " \n ● «NetTerm»:\n  \n"
                                              " In this section of the program, the user\n"
                    ...
                    self.textbox.insert("end", " \n ● Hotkeys:\n \n"
                                               ...
                                               " 12. «PageUp» - scroll up the terminal.\n"
                                               " 13. «PageDown» - scroll down the terminal.\n"
                                        )
                self.textbox.configure(state = "disabled")
            self.bind("<Down>", lambda next: self.textbox.yview_scroll(1, "units"))
            self.bind("<Up>", lambda next: self.textbox.yview_scroll(-1, "units"))
            ...
            if tab_name == "Подключение":
                ...
                if self.language == "Русский":
                    ...
                    self.textbox.insert("end", " \n ● «Горячие» клавиши вкладки:\n \n"
                                               ...
                                               " 11. «F10» - открыть/скрыть меню настроек.\n"
                                        )
                else:
                    self.textbox.insert("end", " \n ● «Connection» tab:\n  \n"
                                               " In this section of the program, the user\n"
                    ...
                    self.textbox.insert("end", " \n ● Hotkeys:\n \n"
                                               ...
                                               " 11. «F10» - open/close settings menu.\n"
                                        )
                self.textbox.configure(state = "disabled")
            self.bind("<Down>", lambda next: self.textbox.yview_scroll(1, "units"))
            self.bind("<Up>", lambda next: self.textbox.yview_scroll(-1, "units"))
            ...
            if tab_name == "База адресов":
                ...
                if self.language == "Русский":
                    ...
                    self.textbox.insert("end", " \n ● «Горячие» клавиши вкладки:\n \n"
                                               ...
                                               "     жатом «CTRL»!\n"
                                               " 20. «F10» - открыть/скрыть меню настроек.\n"
                                        )
                else:
                    ...
                    self.textbox.insert("end", " \n ● Hotkeys:\n \n"
                                               ...
                                               "     is held down!\n"
                                               " 20. «F10» - open/close settings menu.\n"
                                        )
                self.textbox.configure(state="disabled")
        ...
        self.frame_1 = ctk.CTkFrame(master=self, fg_color=("#f2f2f2", "#1a1a1a"))
        ...
        self.button_2 = ctk.CTkButtonSoftHover(master=self.frame_1, font=ctk.CTkFont(family="Trebuchet MS", size=14, weight="bold"), text="Назад", width=100, normal_color="#1F538D", fg_color="#1F538D", hover=False, border_width=0, command=lambda: close_window())
        ...
        self.button_2.bind("<Leave>", lambda out_of_btn: [self.anim_hover.check_color(self.button_2, "1f538d", "0f334d", "10204", modal=True)])  # print("IN")
