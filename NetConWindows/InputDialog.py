...
class InputDialog(ctk.CTkToplevel):
    ...
    def __init__(self,
        ...
        def key_control_v(event):
            if event.keycode == 86:
                ...
                if re.fullmatch(r"^[0-9.]+$", data):
                    ...
                    self.x.trace("w", lambda *args: entry_mask_check(self.x, [u"..." + data], self._entry))
                    self.x.set("")
        ...
        self._entry.bind('<Control-KeyPress>',key_control_v)
        self._entry.bind('<KeyPress>', key_backspace)
        self.ip_entry_string_last_valid = [u"..."]
        self.x.trace("w", lambda *args: entry_mask_check(self.x, self.ip_entry_string_last_valid, self._entry))
        self.x.set("")
        if old_ip != "":
            entry_old_ip(old_ip)
        ...
        self._cancel_button = ctk.CTkButtonSoftHover(master=self.frame_1,
                                        width=100,
                                        border_width=0,
                                        normal_color="#f4740b",
                                        fg_color="#f4740b",
        ...
        self._cancel_button.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self._cancel_button, int("f4740b", 16), int("94440B", 16), int("60300", 16), 10, "down")])
        self._cancel_button._text_label.bind("<Enter>", lambda var_in: self.anim_hover.stop_leave(self._cancel_button))
        self._cancel_button._text_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self._cancel_button, "f4740b", "94440B", "60300"))
        self.frame_1.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self._cancel_button, "f4740b", "94440B", "60300"))
        self.anim_hover.init_hover_state(self._cancel_button)

        self._ok_button = ctk.CTkButtonSoftHover(master=self.frame_1,
                                    width=100,
                                    border_width=0,
                                    normal_color="#1F538D",
                                    fg_color="#1F538D",
        ...
        self._ok_button.bind("<Enter>", lambda go_hover: [self.anim_hover.animate_hover(self._ok_button, int("1f538d", 16), int("0f334d", 16), int("10204", 16), 10, "down")])  # print("IN")
        self._ok_button._text_label.bind("<Enter>", lambda var_in: self.anim_hover.stop_leave(self._ok_button))
        self._ok_button._text_label.bind("<Leave>", lambda var_out: self.anim_hover.go_leave(self._ok_button, "1f538d", "0f334d", "10204"))
        self.frame_1.bind("<Enter>", lambda out_of_btn: self.anim_hover.check_color(self._ok_button, "1f538d", "0f334d", "10204"))
        self.anim_hover.init_hover_state(self._ok_button)
