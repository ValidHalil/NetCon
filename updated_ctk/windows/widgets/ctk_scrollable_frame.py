...
class CTkScrollableFrame(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    def __init__(self,
                 ...
                 orientation2: Literal["vertical", "horizontal"] = "horizontal"):

        self._orientation = orientation
        self._orientation2 = orientation2
        ...
        if self._orientation2 == "horizontal":
            self._scrollbar2 = CTkScrollbar(master=self._parent_frame, orientation="horizontal", command=self._parent_canvas.xview,
                                           fg_color=scrollbar_fg_color, button_color=scrollbar_button_color, button_hover_color=scrollbar_button_hover_color)
            self._parent_canvas.configure(xscrollcommand=self._scrollbar2.set)
        ...
        self._create_window_id2 = self._parent_canvas.create_window(0, 0, window=self, anchor="nw")
    ...
    def _create_grid(self):
        ...
        if self._orientation2 == "horizontal":
            ...
            self._scrollbar2.grid(row=2, column=0, sticky="nsew", padx=border_spacing, pady=1)
    ...
    def configure(self, **kwargs):
        ...
        if "scrollbar_fg_color" in kwargs:
            ...
            self._scrollbar2.configure(fg_color=kwargs.pop("scrollbar_fg_color"))

        if "scrollbar_button_color" in kwargs:
            self._scrollbar.configure(button_color=kwargs.pop("scrollbar_button_color"))
            self._scrollbar2.configure(button_color=kwargs.pop("scrollbar_button_color"))
        ...
        if "scrollbar_button_hover_color" in kwargs:
            ...
            self._scrollbar2.configure(button_hover_color=kwargs.pop("scrollbar_button_hover_color"))
    ...
    def cget(self, attribute_name: str):
        if attribute_name == "width":
            ...
            return self._scrollbar.cget("fg_color"), self._scrollbar2.cget("fg_color")
        elif attribute_name.startswith("scrollbar_button_color"):
            return self._scrollbar.cget("button_color"), self._scrollbar2.cget("button_color")
        elif attribute_name.startswith("scrollbar_button_hover_color"):
            return self._scrollbar.cget("button_hover_color"), self._scrollbar2.cget("button_hover_color")
    ...
    def _fit_frame_dimensions_to_canvas(self, event):
        if self._orientation2 == "horizontal":
            ...
            self._parent_canvas.itemconfigure(self._create_window_id2, width=self._parent_canvas.winfo_width())
