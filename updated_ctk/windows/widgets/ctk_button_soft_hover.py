...
class CTkButtonSoftHover(CTkBaseClass):
    """
    ...
    def __init__(self,
                 ...
                 normal_color: Optional[Union[str, Tuple[str, str]]] = None,
                 hover_color: Optional[Union[str, Tuple[str, str]]] = None,
                 step: Optional[Union[str, Tuple[str, str]]] = None,
    ...
    def configure(self, require_redraw=False, **kwargs):
        ...
        if "normal_color" in kwargs:
            self._normal_color = self._check_color_type(kwargs.pop("normal_color"), transparency=True)
            require_redraw = True
    ...
    def cget(self, attribute_name: str) -> any:
        ...
        elif attribute_name == "normal_color":
    ...
    def _clicked(self, event=None):
        if self._state != tkinter.DISABLED:
            if not self._is_disabled:
                self.after(150, lambda: self.configure(fg_color=self._normal_color))
