...
class CTkComboBox(CTkBaseClass):
    ...
    def _draw(self, no_color_updates=False):
        ...
        if no_color_updates is False or requires_recoloring or requires_recoloring_2:
            ...
            if self._state == tkinter.DISABLED:
                ...
                self._canvas.itemconfig("dropdown_arrow",
                                        fill=self._apply_appearance_mode(("gray14", "gray84")))
    ...
    def _on_enter(self, event=0):
        if self._hover is True and self._state != tkinter.DISABLED and len(self._values) > 0: # self._state == tkinter.NORMAL
    ...
    def _clicked(self, event=None):
        if self._state is not tkinter.DISABLED and len(self._values) > 0:
            self._on_enter() # добавлено, так же как и изменено условие в enter
